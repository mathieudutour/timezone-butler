...
export default async function slackDirectInstall(
  ...
  res.redirect(
    ...
    }&scope=app_mentions:read,channels:history,chat:write,groups:history,groups:write,im:history,im:write,mpim:history,mpim:write,team:read,users:read&state=${state}&redirect_uri=${encodeURIComponent(
